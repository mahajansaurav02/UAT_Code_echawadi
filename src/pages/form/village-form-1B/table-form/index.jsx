  ...
  return (
    <>
      <PageContainer>
        ...
        <Alert
          message="टीप"
          description="खालील तक्त्यातील माहिती इ-फेरफार प्रणालीतून घेतली आहे.ज्या सातबारावरील भूधारणा प्रकार 'सरकार' असा आहे,केवळ तेच सातबारा येथे दिसतील. 'सरकार भूधारणा असणारे' जे गट या भूधारणाखाली नोंदवलेले नाहीत त्यांची नोंदणीची कार्यवाही इ-फेरफार प्रणालीतून पूर्ण करा.   "
          type="info"
          showIcon
        />
        {isNirank && (
